...
import javax.swing.undo.*;
 class UndoableTextArea extends TextArea implements StateEditable {
	 private final String KEY_STATE = "UndoableTextAreaKey";
...
public class main extends Frame{
		...
		main(){
			...
			MenuItem o = new MenuItem("New",new MenuShortcut(KeyEvent.VK_O));
			MenuItem s = new MenuItem("New",new MenuShortcut(KeyEvent.VK_S));
			MenuItem e = new MenuItem("New",new MenuShortcut(KeyEvent.VK_E));
	...
	class Open implements ActionListener{
		public void actionPerformed(ActionEvent ae) {
			FileDialog fd = new FileDialog(main.this,"Select");
			fd.show();
	...
	class Save implements ActionListener{
		public void actionPerformed(ActionEvent ae) {
			FileDialog fd = new FileDialog(main.this,"SaveFile",FileDialog.SAVE);
			fd.setFile(fn);
			fd.setDirectory(dn);
			fd.show();
			if(fd.getFile()!=null) {
	...
	class Paste implements ActionListener{
	 ...
	 class ConfirmDialog extends WindowAdapter{
	...
	class B extends colorChooser implements ActionListener{
		public void actionPerformed(ActionEvent e) {
