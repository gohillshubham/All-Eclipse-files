 ...
 public void actionPerformed(ActionEvent e) {
  ...
  if(e.getSource()==btn)
   if(Pswd.equals(CPswd)){
    try {
     Connection connection = (Connection)DriverManager.getConnection("jdbc:mysql://localhost:3306/user","root", "Saurav@45");
     PreparedStatement st = (PreparedStatement) connection.prepareStatement("INSERT INTO student(name,email,mob,usr,password)"+"VALUES(?,?,?,?,?);");
     st.setString(1, Name);
